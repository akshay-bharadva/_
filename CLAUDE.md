...
This repository is a personal portfolio website and headless CMS / “Personal OS” built with Next.js 14 App Router. It supports a zero-config static portfolio mode using fallback data and a dynamic CMS/admin mode backed by Supabase. The site builds to a static export deployable to any static host, with public portfolio/content routes and an authenticated Personal OS for managing tasks, learning, finance, content, notes, whiteboards, and other personal data.
