      ...
      >
        ...
        <div className="flex md:flex-col gap-4 md:gap-3">
          ...
          <div>
            ...
            <div className="mt-1">
              <DateRange from={item.date_from} to={item.date_to} chip={false} />
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          {item.description && (
            <ItemMarkdown
              className="prose-ul:space-y-1.5 prose-ul:mt-0
          ...
          <TagList tags={item.tags} bordered={false} className="mt-4" />
        </div>
      </motion.div>
    ))}
  </div>
