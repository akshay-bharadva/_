...
const TYPES =
  "UUID|TEXT|INT|INT2|INT4|INT8|BIGINT|SMALLINT|BOOLEAN|NUMERIC|DATE|TIMESTAMPTZ|TIMESTAMP|JSONB|JSON|CHAR|VARCHAR|[a-z_]+_type|[a-z_]+_status|[a-z_]+_frequency";
