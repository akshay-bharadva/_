...
Upload `./out/` via **Settings → Pages → Deploy from a branch**, or use any
static-site action you prefer.

For dynamic mode, set these in your CI secret store or hosting dashboard:
